...
public:
	LoginReq(std::string& username, std::string& password) : mUsername{username}, mPassword {password} {
...
public:
	LogoutReq(std::string& username) : mUsername{username} {
...
public:
	LeaveReq(std::string& username) : mUsername{username} {
...
public:
	Data(std::string& username,	std::vector<Par>& data) : mUsername{username}, mData{data}  {
